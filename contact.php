    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
					...
					34/44 Nayapura kareli,Prayagraj<br>
					Prayagraj-211006.<br>
					Prayagraj Allahabad
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 9506039470,7236049131</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="https://threebestrated.in/24-hour-blood-banks-in-allahabad-up" >bloodbankin@gmail.com</a>
                </p>
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    ...
                    <li>
                        <a href="https://www.google.co.in/"><i class="fa fa-google-plus-square fa-2x"></i></a>
                    </li>
                </ul>
            </div>
        </div>
